...
var reportShape = (value) => record(value) && value.version === 1 && typeof value.experiment === "string" && typeof value.baseline === "string" && typeof value.incomplete === "boolean" && (value.compositions === void 0 || Array.isArray(value.compositions)) && Array.isArray(value.variants) && value.variants.every(
...
var reportTools = /* @__PURE__ */ new Set(["profile_lab_run", "profile_lab_compare"]);
...
function EmptyState() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "pl-root pl-empty", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "pl-empty-card", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "\u8FD0\u884C\u8BC4\u6D4B\u540E\uFF0C\u5DE5\u5177\u4F1A\u81EA\u52A8\u751F\u6210\u62A5\u544A\u5E76\u663E\u793A\u5728\u8FD9\u91CC\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "pl-how", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "\u5728\u5BF9\u8BDD\u4E2D\u8BA9\u6A21\u578B\u8FD0\u884C\u5B9E\u9A8C\uFF1B\u5B8C\u6210\u540E\u62A5\u544A\u4F1A\u81EA\u52A8\u663E\u793A\u3002" })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pl-card", children: report.variants.map((variant) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "pl-variant", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              ...
              composition && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "pl-composition", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                  "Profile \xB7 ",
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: composition.profile })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                  "Patch \xB7 ",
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: composition.patch })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: composition.layers.length ? composition.layers.map((layer) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "pl-layer", children: [
                  layer.id,
                  layer.keys.length ? ` \xB7 ${layer.keys.join(" / ")}` : ""
                ] }, layer.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "pl-layer", children: "\u65E0\u989D\u5916 Patch" }) }),
                composition.layers.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "pl-patch-details", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: "\u5C55\u5F00 Patch \u5185\u5BB9" }),
