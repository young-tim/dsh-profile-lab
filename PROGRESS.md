...
- Goal: publishable local-first DSH Profile Lab using reproducible fake-driver matrices.
- Order: foundation → isolated execution/resume → reports/gate → CLI/plugin → release proof.
- Maximum risk: DSH preview profile contract may differ from the documented RC interface.
- 2026-08-18: Task 0 verified Node v24.12.0, pnpm 11.9.0, DSH 0.1.0-rc.7 and `dsh` bin.
- 2026-08-18: Registry omitted DSH `engines`; evidence is isolated in BLOCKED.md.
